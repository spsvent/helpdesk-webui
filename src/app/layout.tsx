    ...
    return (
      <html lang="en">
        <head>
          ...
          {/* eslint-disable-next-line @next/next/no-page-custom-font -- rule targets the Pages Router's _document.js; this is the App Router root layout, whose <head> is document-level and applies to every route */}
